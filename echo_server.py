    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                # sock.close() # If I close the connection here than only one of the tests passes
                # but if I leave this open, the server does not close itself after the exchange is complete
                print(
